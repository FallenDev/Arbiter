...
public class Crc32ProviderTests
{
    #region Default Table

    private static readonly uint[] ExpectedDefaultTable =
    [
    ...
    private Crc32Provider _provider;
    ...
    [TestCase(new byte[] { 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf },
        ExpectedResult = (uint)0xF5A6AA3A)]
    [TestCase(new byte[] { 0xf, 0xe, 0xd, 0xc, 0xb, 0xa, 0x9, 0x8, 0x7, 0x6, 0x5, 0x4, 0x3, 0x2, 0x1 },
        ExpectedResult = (uint)0x52A82B9F)]
    public uint Should_Calculate_Crc32_Correctly(byte[] data)
    {
