...
public class ClientPacketEncryptorTests
{
    ...
    public void Should_Decrypt_With_Static_Key()
    {
        ...
        // The decrypted payload should be 01 00 00 1B 66 00
        Assert.That(decrypted.Data, Is.EqualTo(new byte[] { 0x01, 0x00, 0x00, 0x1B, 0x66, 0x00 }));
    }
    ...
    public void Should_Decrypt_With_Hash_Key()
    {
        ...
        Assert.That(decrypted.Data, Is.EqualTo(decodedBioBytes));
    }
    ...
    public void Should_Decrypt_Dialog_Menu_Choice()
    {
        ...
        // The decrypted payload should be 01 00 00 1B 66 04 B9 00
        Assert.That(decrypted.Data, Is.EqualTo(new byte[] { 0x01, 0x00, 0x00, 0x1B, 0x66, 0x04, 0xB9, 0x00 }));
    }
    ...
    public void Should_Decrypt_Dialog_Choice()
    {
        ...
        // The decrypted payload should be 01 00 00 1B 66 00 B9 00 5C 00
        Assert.That(decrypted.Data,
            Is.EqualTo(new byte[] { 0x01, 0x00, 0x00, 0x1B, 0x66, 0x00, 0xB9, 0x00, 0x5C, 0x00 }));
    }
}