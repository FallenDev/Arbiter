...
public class ServerUpdateStatsMessage : IPacketMessage
{
    ...
    [InspectProperty]
    public bool? CanFastMove { get; set; }
    ...
    public void ReadFrom(NetworkPacketReader reader)
    {
        ...
        IsAdmin = UpdateType.HasFlag(ServerUpdateStatsFlags.GameMasterA) && !UpdateType.HasFlag(ServerUpdateStatsFlags.GameMasterB);
        ...
        if (UpdateType.HasFlag(ServerUpdateStatsFlags.Modifiers))
        {
            ...
            CanFastMove = reader.ReadBoolean();
